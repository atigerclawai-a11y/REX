#!/usr/bin/env python3
"""Masha reservation watcher — check Gmail inbox via Gmail API directly."""
import json, sys, urllib.request, urllib.error, os, ssl
...
try:
    ...
    print(json.dumps({"ok": True, "messages": inbox, "account": "gmail"}))
except urllib.error.HTTPError as e:
    body = e.read().decode() if e.fp else ""
    print(json.dumps({"error": f"Gmail API error: {e.code} {e.reason}", "body": body[:500]}))
except Exception as e:
