#!/usr/bin/env python3
"""
REX — Thursday Gemini Training Runner (2026-05-28)
====================================================
...
Run with the REX virtualenv active:
    source .venv/bin/activate && python run_gemini_thursday_2026-05-28.py
"""
...
def append_log(quiz_info: dict, tg_info: dict, app_path: Path):
    ...
    block.append("    extended from the 2026-05-07 Thursday Gemini session lessons.")
    block.append("")
    ...
    block.append("  [context, all]: Gemini 2026-05-28 training session record")
    block.append("")
